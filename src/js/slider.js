let initSliders = function () {
  let initBrandsSliders = function () {
    ...
    let brandItemTemplateMobile = document.querySelector('#swiper-template-brands').content.querySelector('.brands__item');
  ...
  let initServicesSliders = function () {
    ...
    let servicesSliderMobile = document.querySelector('.services__slider-mobile');
    let servicesList = document.querySelector('.services__list');
    let servicesListMobile = servicesSliderMobile.querySelector('.services__list');

    let servicesItems = servicesList.children;
    let servicesItemsMobile = servicesListMobile.children;
    let serviceItemTemplateMobile = document.querySelector('#swiper-template-services').content.querySelector('.services__item');
    let serviceItemTemplate = document.querySelector('#service-template').content;
    ...
    let setSliderItems = function (numOfElems) {
      ...
      if (screenWidth >= 768) {
        for (let i = servicesItems.length; i <= numOfElems; i++) {
          ...
          let validServiceText = serviceLink.textContent.replace('Ремонт устройства #1', 'Ремонт устройства # ' + (i + 1));
        ...
        for (let i = servicesItemsMobile.length; i <= numOfElems; i++) {
          ...
          let serviceLink = servicesItemsMobile[i].querySelector('.services__link');
          let validServiceText = serviceLink.textContent.replace('Ремонт устройства #1', 'Ремонт устройства # ' + (i + 1));
          serviceLink.textContent = validServiceText;
        }
      }
